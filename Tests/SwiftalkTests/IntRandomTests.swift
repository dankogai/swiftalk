...
@Suite("Int.random(in:) (round 109) — the only form; round 120 took back round 119's to:/from:")
struct IntRandomTests {
    ...
    func errors() throws {
        ...
        #expect(throws: SwiftalkError.self) { try eval("Int.random(to: 6)") }             // round 120: Int has a Range
        #expect(throws: SwiftalkError.self) { try eval("Int.random(from: 0, to: 6)") }
        #expect(try eval("Int.random(in: Int.min...Int.max).Type == Int") == .bool(true))   // the whole line
